...
LANGUAGE.load_selected_config        = "Load selected Config"
...
LANGUAGE.game_active                 = "GAME ACTIVE - [%s]" --|
...
LANGUAGE.switch_sandbox              = "Switch to Sandbox"
LANGUAGE.cancel                      = "Cancel"
LANGUAGE.config_mismatch             = "Config Mismatch! (%s)" --|
...
LANGUAGE.round_now_is                = "Round is now: %d"
...
LANGUAGE.no_configs_current          = "No Configs for the current map"
LANGUAGE.missing_addons              = "Missing Addons  [%s]"  --|
